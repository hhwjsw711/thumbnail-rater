  ...
  return (
    <div className="prose dark:prose-invert container py-12">
      ...
      <p>
        ...
        accessible from https://thumbnailrater.com, and any other services
      ...
      <p>
        ...
        shared and/or collect in ThumbnailRater. This policy is not
      ...
      <p>
        ...
        When you sign up, we are provided with your name, email, and profile
        picture which comes from your google account information. We use this
        information for personalization and any essential communication with
        you. We never sell your data.
      </p>

      <p>
        <strong>Voluntary Correspondence:</strong> We retain questions or
        assistance requests, including your email, for future reference.
      </p>

      <p>
        <strong>Marketing Communications:</strong> Your email is processed for
        direct marketing and support. Unsubscribe anytime, and we promptly
