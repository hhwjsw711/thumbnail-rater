...
export const en: TranslationType = {
  ...
  notificationsTabComments: "Comments",
  notificationsNewThumbnailTitle: "New Thumbnail",
  notificationsNewThumbnailDescription: "uploaded a new thumbnail test!",
  notificationsNewCommentTitle: "New Comment",
  notificationsNewCommentDescription: "left a comment on your thumbnail.",
  notificationsNewVoteTitle: "New Vote",
  notificationsNewVoteDescription: "voted for one of your thumbnail images.",
  notificationsButtonView: "View",
  notificationsButtonRead: "Read",
  notificationsNoNotifications: "You have no notifications",
  profileNoThumbnailTests: "You have no thumbnail tests",
  profileCreateThumbnailTestButton: "Create a Thumbnail Test",
  profileImageTestAlt: "image test",
  profileVotesLabel: "votes:",
  profileViewResultsButton: "View Results",
